...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا يسطا  {mention} **\
                        \n**⌔︙ {my_mention}'انا البوت المساعد .**\
                        \n**⌔︙ يمكنك التواصل مع صاحب البوت فقط ارسل رسالتك 👤.**\
                        \n\n**⌔︙ البوت خاص بسورس :** [𝗰.ًًٍٍ𝗥 ََِ𝘀ُُ𝗼ًًٍٍ𝗨ًًٍٍ𝗥ََِِ𝗰ََِِ𝗲](https://t.me/cr_source)"
        buttons = [
            (
                Button.url("تنصيب سورسنا", "https://heroku.com/deploy?template=https://github.com/xlucifer711/sbb_b"),
                Button.url(
                    "جروب المساعده",
                    "https://t.me/gro_up_1",
                ),
