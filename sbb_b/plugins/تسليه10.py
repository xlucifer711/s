...
@sbb_b.ar_cmd(pattern=r"سبونج بوب"))
async def kek(kek):
    await kek.edit(M)
...
@sbb_b.ar_cmd(pattern=r"ثعلب"))
async def fox(fox):
    await fox.edit(F)


@sbb_b.ar_cmd(pattern=r"فيل"))
async def elephant(elephant):
    await elephant.edit(E)


@sbb_b.ar_cmd(pattern=r"معصب"))
async def homer(homer):
    await homer.edit(H)


@sbb_b.ar_cmd(pattern=r"خنزير"))
async def pig(pig):
    await pig.edit(P)
...
@sbb_b.ar_cmd(pattern=r"معارض"))
async def marth(marth):
    await marth.edit(L)



@sbb_b.ar_cmd(pattern="مروحيه(?: |$)(.*)"))
async def _(event):
...
@sbb_b.ar_cmd(pattern="ابره(?:\s|$)([\s\S]*)"))
